...
const CreateForm: React.FC = () => {
  ...
  // Start with empty form by default - no questions loaded initially
  useEffect(() => {
    // Starting with empty form, so no questions are loaded by default
    // Users can choose to load built-in questions or create their own
              ...
              {formData.form_type === 'empty' ? (
                <>
                  ...
                  <p className="text-gray-500 mb-6">
                    You've chosen to start with an empty form. Build your feedback form from scratch by adding your own custom questions.
                  </p>
                  <button
                    type="button"
